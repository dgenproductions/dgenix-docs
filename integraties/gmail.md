...
**Assistent reageert niet op Gmail:** Controleer of je Gmail-koppeling actief is in **Instellingen → Integraties**. Als de status "Niet verbonden" toont, koppel opnieuw.

**Vragen?** Stuur een bericht naar [info@dgenproductions.nl](mailto:info@dgenproductions.nl).
