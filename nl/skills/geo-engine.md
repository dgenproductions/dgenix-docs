...
1. Ga naar **Dashboard -> Skills** en activeer de **GEO Engine** (of open hem direct als je op Pro+ zit)
2. Ga via het zijmenu naar **Groei Tools -> GEO Engine**
3. Voer je website-URL in en klik op **Site toevoegen**
...
`llms.txt` is een standaard bestand (vergelijkbaar met `robots.txt`) waarmee je AI-zoekmachines vertelt welke content ze mogen lezen en indexeren. De GEO Engine genereert een op maat gemaakt `llms.txt`-bestand op basis van je website-inhoud.
