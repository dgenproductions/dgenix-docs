...
Door je Gmail te koppelen kan je AI-assistent je inbox lezen, e-mails categoriseren en conceptantwoorden schrijven.

> Gmail is inbegrepen bij **alle plannen**, Starter, Growth en Pro.

---

## Wat kan je assistent met Gmail?
...
1. Ga naar **Dashboard → Connectors**
2. Klik op **"Verwijder"** naast Gmail
...
**Koppeling mislukt:** Probeer het opnieuw en zorg dat je bent ingelogd op het juiste Google account in je browser.

**Assistent reageert niet op Gmail:** Controleer of je Gmail-koppeling actief is in **Connectors**. Als de status "Niet verbonden" toont, koppel opnieuw.
